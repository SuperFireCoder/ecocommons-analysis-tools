...
describe("In order to use the analysis features; as a User; I should be able to find the options and see analysis progress", () => {
    ...
    it("Coding Cloud servers requires login", () => {
        ...
        cy.get("button").should("not.contain", "Launch notebook server", {
            timeout: 2000
        });
    });
    ...
    it('Coding Cloud server "Notebook" can be started', () => {
        ...
        cy.get("td", { timeout: 10000 }).should("contain", "PENDING");
        cy.get("td").should("contain", "EcoCommons SciPy environment");
        ...
        cy.get("td").should("contain", "RUNNING");
        cy.window().then((win) => {
        ...
        cy.get("@redirect").should(
            "be.calledWith",
            "https://jupyterhub.dev.ecocommons.org.au/hub/oauth_login?next=%2Fhub%2F"
        );
    ...
    it('Coding Cloud server "Datascience" can be started', () => {
        ...
        // Pending machine start
        cy.get("td", { timeout: 10000 }).should("contain", "PENDING");
        cy.get("td").should("contain", "Datascience environment");
    ...
    it('Coding Cloud server "EcoCommons R" can be started', () => {
        ...
        // Pending machine start
        cy.get("td", { timeout: 10000 }).should("contain", "PENDING");
        cy.get("td").should("contain", "EcoCommons R environment");
